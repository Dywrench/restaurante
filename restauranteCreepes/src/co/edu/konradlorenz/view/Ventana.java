    ...
    private void seleccionarPlato() {
        ...
        for (int i = 0; i < cantidad; i++) {
            Plato platoSeleccionado = new Plato(
                platosDisponibles.get(numPlato).getNombrePlato(),
                platosDisponibles.get(numPlato).getBebida(),
                new ArrayList<>(),
                platosDisponibles.get(numPlato).getPrecio()
            );
            ...
            mesero.agregarPlato(platoSeleccionado, 1);
        }
    }
